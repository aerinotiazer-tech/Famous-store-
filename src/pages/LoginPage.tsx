  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-black pt-24 pb-12 px-4 flex items-center justify-center transition-colors">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-neutral-900 dark:text-white text-center mb-2">Bon Retour</h1>
        <p className="text-neutral-500 dark:text-neutral-400 text-center mb-8">Connectez-vous à votre compte Famous Store</p>
