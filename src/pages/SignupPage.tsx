  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code === 'auth/email-already-in-use') {
        ...
        setError('Veuillez activer l\'authentification "Email/Mot de passe" dans la console Firebase (Authentication > Sign-in method).');
      } else {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-black pt-24 pb-12 px-4 flex items-center justify-center transition-colors">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-neutral-900 dark:text-white text-center mb-2">Créer un compte</h1>
        <p className="text-neutral-500 dark:text-neutral-400 text-center mb-8">Rejoignez Famous Store aujourd'hui</p>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div>
            <label className="text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1.5 block">Adresse Email</label>
            <input 
               type="email" 
               value={email}
          ...
          <div>
            <label className="text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1.5 block">Mot de passe</label>
            <input 
               type="password" 
               value={password}
          ...
          <div>
            <label className="text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1.5 block">Confirmer le mot de passe</label>
            <input 
               type="password" 
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-6 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 text-neutral-900 dark:text-white font-medium py-3 rounded-xl hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
          >
